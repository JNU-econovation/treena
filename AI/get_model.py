...
def get_model(model):
	...
	try:
		model = ElectraForMultiLabelClassification.from_pretrained(model)
...
get_model("monologg/koelectra-small-v3-goemotions")
get_tokenizer("monologg/koelectra-small-v3-goemotions")
